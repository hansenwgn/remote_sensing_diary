...
<center>![NDVI time-series data derived from Landsat images, compiled using Google Earth Engine, were then used to classify and distinguish irrigated from rainfed areas](image/gee4.png)</center>
